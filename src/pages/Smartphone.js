...
export default function Smartphone() {
    return (
        <>
            ...
            >
            NOTE: The below features are available for the latest iOS and may not be available on older versions
            <h3>Photo Editing</h3>
            <ul>
            ...
            <ul>
                ...
                <li>Tap the share icon (square with up arrow) in bottom left corner</li>
